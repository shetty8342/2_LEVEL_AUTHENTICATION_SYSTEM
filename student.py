...
class Student:
    def __init__(self,root):
        ...
        img=Image.open(r"C:\Users\SHISHIR\Desktop\2_LEVEL_AUTHENTICATION_SYSTEM\images\students.jpg")
        ...
        #second_image
        img1=Image.open(r"C:\Users\SHISHIR\Desktop\2_LEVEL_AUTHENTICATION_SYSTEM\images\student1.jpg")
        ...
        #third_image
        img2=Image.open(r"C:\Users\SHISHIR\Desktop\2_LEVEL_AUTHENTICATION_SYSTEM\images\student2.jpg")
        ...
        #bg_image
        img3=Image.open(r"C:\Users\SHISHIR\Desktop\2_LEVEL_AUTHENTICATION_SYSTEM\images\face.jpg")
        ...
        title_lbl=Label(bg_img,text="STUDENT MANAGEMENT SYSTEM",font=("times new roman",35,"bold"),bg="purple",fg="yellow")
        ...
        Left_frame.place(x=10,y=2,width=735,height=580)
        
        img_left=Image.open(r"C:\Users\SHISHIR\Desktop\2_LEVEL_AUTHENTICATION_SYSTEM\images\attendance1.jpg")
        img_left=img_left.resize((720,150),Image.Resampling.LANCZOS)
        ...
        # Department
        dept_label=Label(current_course_frame,bg="white",text="Department",font=("times new roman",13,"bold"))
        dept_label.grid(row=0,column=0,padx=10,sticky=W)
        
        dept_combo=ttk.Combobox(current_course_frame,textvariable=self.var_department,font=("times new roman",13,"bold"),width=17,state="readonly")
        ...
        # Year 
        year_label=Label(current_course_frame,bg="white",text="Academic Year",font=("times new roman",13,"bold"))
        ...
        class_Student_frame.place(x=5,y=250,width=720,height=310)
        ...
        email_label=Label(class_Student_frame,bg="white",text="Email No:",font=("times new roman",13,"bold"))
        ...
        # phone no
        phone_label=Label(class_Student_frame,bg="white",text="phone No:",font=("times new roman",13,"bold"))
        ...
        btn_frame1.place(x=0,y=225,width=725,height=35)
        ...
        img_right=Image.open(r"C:\Users\SHISHIR\Desktop\2_LEVEL_AUTHENTICATION_SYSTEM\images\student5.jpg")
        img_right=img_right.resize((720,150),Image.Resampling.LANCZOS)
        ...
        search_label=Label(Search_frame,bg="red",text="Search By:",font=("times new roman",13,"bold"),fg="white")
        ...
        self.students_table=ttk.Treeview(table_frame,column=("department","course","year","semester","ID","name","DIV","Roll","gender","dob","Email","phone","address","teacher","photo"),xscrollcommand=scroll_x.set,yscrollcommand=scroll_y)
        ...
        self.students_table.column("department",width=100)
        ...
        self.students_table.column("photo",width=150)
    ...
    def add_data(self):
        if self.var_department.get()=="Select Department" or self.var_name.get()=="" or self.var_ID.get()=="":
            ...
            try:
                 conn=mysql.connector.connect(host="localhost",username="root",password="1234qweR@",database="face_recognizer")
    ...
    def delete_data(self):
        if self.var_ID.get()=="":
            messagebox.showerror("Error","Studentt id must be required",parent=self.root)
        else:
            try:
    ...
    def generate_dataset(self):
        if self.var_department.get()=="Select Department" or self.var_name.get()=="" or self.var_ID.get()=="":
            ...
            #   ================================ Load predefined data on face fronts from opencv ===========================
                face_classifier=cv2.CascadeClassifier("C:\\Program Files\\Python38\\Lib\\site-packages\\cv2\\data\\haarcascade_frontalface_default.xml")   
