...
class Face_Recognition:
    def __init__(self,root):
        ...
        title_lbl=Label(self.root,text="Face Recognition",font=("times new roman",35,"bold"),bg="lightblue",fg="red") 
        ...
        img_bottom=Image.open(r"C:\Users\SHISHIR\Desktop\2_LEVEL_AUTHENTICATION_SYSTEM\images\facerecognize.jpeg")
        ...
        b1_1=Button(f_lbl,text="Face Recognition",cursor="hand2",command=self.face_recog,font=("times new roman",18,"bold"),bg="darkblue",fg="yellow")
        b1_1.place(x=365,y=620,width=200,height=40)

    def mark_attendance(self,i,r,n,d):
        with open("Shishir.csv","r+",newline="\n") as f:
